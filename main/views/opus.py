...
def generateWordCloud(txt, height=500, width=500):
    ...
    cloud = wordcloud.WordCloud(width=width, height=height, font_path="static/fonts/SourceHanSansSC-Regular.otf", background_color=None, mode='RGBA').generate(seg_str)
